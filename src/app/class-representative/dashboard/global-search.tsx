...
import { useCRSearch } from '@/hooks/use-cr-search';
import { Content } from './types';
import { cn } from '@/lib/utils';

interface GlobalSearchProps {
  onSearchChange: (results: Content[] | null) => void;
  allContent: Content[];
}
...
export default function GlobalSearch({ onSearchChange, allContent }: GlobalSearchProps) {
  const {
    query,
    handleQueryChange,
    filteredResults,
    ...
    setIsFocused,
    selectItem,
  } = useCRSearch(onSearchChange, allContent);
