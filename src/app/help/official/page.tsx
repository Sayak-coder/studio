...
export default function AuthPage({ params }: { params: { category: string } }) {
  const categoryTitle = 'Official Portal';
      ...
      <div className="w-full max-w-md text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-muted-foreground mt-2">Existing official? Log in here.</p>
          </Link>
          <Link 
          ...
          >
            <h2 className="text-2xl font-semibold">Sign Up</h2>
             <p className="text-muted-foreground mt-2">New official? Create an account.</p>
          </Link>
        </div>
