    ...
    <div className="space-y-6">
      <div className="flex w-full items-center space-x-2">
        <Input
          ...
          className="text-base"
        />
        <Button onClick={handleGetHelp} disabled={loading} className="px-6">
      ...
      {result && (
        <div className="pt-4 animate-fade-in-up">
            ...
            <div className="mt-4">
              <h4 className="mb-2 font-semibold text-muted-foreground">Related Topics:</h4>
